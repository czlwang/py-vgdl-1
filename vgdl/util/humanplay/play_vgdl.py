...
def main():
    ...
    parser.add_argument('--visualize_diag', action='store_true', dest='visualize_diag', default=False, help="show RuleLang diag on humanplay")
    ...
    controller = controller_cls(env_name, args.tracedir, 
                                machinations_host=args.machinations_host, graph_xml=args.graph_xml_path,
                                visualize_diag=args.visualize_diag)
